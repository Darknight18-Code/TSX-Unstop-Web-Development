...
export const setupProgressBars = () => {
  ...
  const animateProgressBars = () => {
    progressBars.forEach(bar => {
      const isVisible = isInViewport(bar.parentElement, 0.3);
      const filled = bar.classList.contains('filled');
  ...
  window.addEventListener('scroll', throttle(animateProgressBars, 150), { passive: true });
